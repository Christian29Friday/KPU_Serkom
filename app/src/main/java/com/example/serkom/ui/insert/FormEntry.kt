...
import com.example.serkom.CameraActivity
import com.example.serkom.camera.reduceFileImage
import com.example.serkom.camera.rotateBitmap
import com.example.serkom.camera.uriToFile
import com.example.serkom.database.DataPemilih
import com.example.serkom.databinding.ActivityFormEntryBinding
import com.example.serkom.helper.ViewModelFactory
                ...
                datapemilih?.let { datapemilih ->
                    ...
                    if (datapemilih?.gambar != null) {
                        ...
                        Glide.with(applicationContext)
                            .load(R.drawable.ic_picture) // Ganti dengan resource ID placeholder yang sesuai
